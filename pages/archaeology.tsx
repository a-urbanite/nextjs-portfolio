const Archaeology = () => {
  ...
  return (
        <article className='page'>
            ...
            <ul>
                <li>
                    I started to study Prehistoric Archaeology at the Free University Berlin in 2009. 
                </li>
                <li>
                    In 2013 I graduated with the Bachelor of Arts and continued directly with the consecutive Master in the same field.
                </li>
                <li>
